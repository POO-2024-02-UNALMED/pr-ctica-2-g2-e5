...
class Obra:
    ...
    def __init__(self, audienciaEsperada = 0, nombre = "", calificacion = 0, reparto = [], papeles = [], director = None, costoProducción = 0, funcionesSemana = [], genero = None, tiquetesTotales = 0, estadoCriticoA = False, calificaciones = [], franjaHoraria = [],
        ...
        if self.__nombre !="NOTFORITEA":
            self.franjaHoraria(genero)
        if self.__nombre != "NOTFORITE" and self.__nombre !="NOTFORITEA":
    ...
    def franjaHoraria(self, genero):
        ...
        a = Funcion.Funcion(obra = Obra(nombre="NOTFORITEA"),horario = [datetime.datetime(year=2024,month=1,day=2,hour=0,minute=0), datetime.datetime(year=2024,month=1,day=2,hour=0,minute=0)])
