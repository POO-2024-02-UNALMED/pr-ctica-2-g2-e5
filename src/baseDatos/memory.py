...
def resetMemory():
    ...
    obraNFI1.setFuncionEstelar(Funcion(obra = obraNFI1, horario = horarioObra1F))
    obraNFI2.setFuncionEstelar(Funcion(obra = obraNFI2, horario = horarioObra2F))
    obraNFI3.setFuncionEstelar(Funcion(obra = obraNFI3, horario = horarioObra3F))
    obraNFI4.setFuncionEstelar(Funcion(obra = obraNFI4, horario = horarioObra4F))
    obraNFI5.setFuncionEstelar(Funcion(obra = obraNFI5, horario = horarioObra5F))
    obraNFI6.setFuncionEstelar(Funcion(obra = obraNFI6, horario = horarioObra6F))
    obraNFI7.setFuncionEstelar(Funcion(obra = obraNFI7, horario = horarioObra7F))
    obraNFI8.setFuncionEstelar(Funcion(obra = obraNFI8, horario = horarioObra8F)) 
